...
## Proyecciones de población en Argentina
...
El objetivo de este documento es presentar una forma programática de procesamiento de las proyecciones de poblacion 2010-2040 publicadas por el INDEC, usando el software estadístico R y con sus librerías dplyr, openxl y readxl
       ...
       highcharter::renderHighchart({
        ...
        highchart() %>% 
          ...
          hc_plotOptions(series = list(stacking = "normal",
                                       ...
                                       pointPadding = 0,
                                       borderWidth = .1)) %>%
          hc_add_series(name = "Varones", 
                        data = rev(datos_grafico$poblacion[datos_grafico$sexo_codigo=="1"])*-1, 
                        color = "#d8b365") %>%
