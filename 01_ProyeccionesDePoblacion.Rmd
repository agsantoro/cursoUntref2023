...
Identificamos la letra "B" en el vector LETTERS que incluye R. En este caso, la letra "B" es la segunda del vector. Usando esa posición, iremos agregando los múltiplos de 4 hasta completar las 5 columnas.
